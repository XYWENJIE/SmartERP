package com.benjamin.smarterp.security.oauth2;

import com.benjamin.smarterp.domain.entity.oauth2.Authorization;
import com.benjamin.smarterp.repository.jpa.AuthorizationRepository;
...
public class OAuth2AuthorizationServiceImpl implements OAuth2AuthorizationService {
    ...
    public OAuth2AuthorizationServiceImpl(AuthorizationRepository authorizationRepository, RegisteredClientRepository registeredClientRepository, ObjectMapper objectMapper) {
    ...
    public OAuth2Authorization findById(String id) {
        ...
        Optional<Authorization> result = this.authorizationRepository.findById(id);
    ...
    private OAuth2Authorization toObject(Authorization entity){
        ...
        if(registeredClient == null){
            throw new DataRetrievalFailureException("在RegisteredClientRepository中未找到ID为"+entity.getRegisteredClientId()+"的RegisteredClient");
        }
        ...
        OAuth2Authorization.Builder builder = OAuth2Authorization.withRegisteredClient(registeredClient)
                ...
                .authorizedScopes(StringUtils.commaDelimitedListToSet(entity.getAuthorizationScope()))
        ...
        if(entity.getAccessTokenValue() != null) {
        	OAuth2AccessToken accessToken = new OAuth2AccessToken(OAuth2AccessToken.TokenType.BEARER, entity.getAccessTokenValue(), entity.getAccessTokenIssuedAt(), entity.getAccessTokenExpiresAt());
        ...
        if(entity.getRefreshTokenValue() != null) {
        	...
        	builder.token(refreshToken,metadad -> metadad.putAll(parseMap(entity.getRefreshTokenMetadata())));
        }
        
        if(entity.getOidcIdTokenValue() != null) {
        	OidcIdToken idToken = new OidcIdToken(entity.getOidcIdTokenValue(), entity.getRefreshTokenIssuedAt(), entity.getOidcIdTokenExpiresAt(), parseMap(entity.getOidcIdTokenClaims()));
    ...
    private Authorization toEntity(OAuth2Authorization authorization){
        ...
        entity.setAuthorizationScope(StringUtils.collectionToCommaDelimitedString(authorization.getAuthorizedScopes()));
