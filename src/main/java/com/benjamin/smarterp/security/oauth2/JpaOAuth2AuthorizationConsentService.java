...
import com.benjamin.smarterp.repository.jpa.AuthorizationConsentRepository;
...
public class JpaOAuth2AuthorizationConsentService implements OAuth2AuthorizationConsentService{
	...
	public void save(OAuth2AuthorizationConsent authorizationConsent) {
		Assert.notNull(authorizationConsent, "authorizationConsent授权同意对象不能空");
	...
	private OAuth2AuthorizationConsent toObject(AuthorizationConsent authorizationConsent) {
		...
		if(registeredClient == null) {
			throw new DataRetrievalFailureException("ID为’"+registeredClientId+"’的RegisteredClient在RegisteredClientRepository中未找到。");
		}
