...
public class PersonnelService {
     ...
     */
    public OutputStream generationLaborContract(Personnel personnel, Team team) throws IOException {
        ...
        if(optionalTemplate.isPresent()){
            ...
            HtmlConverter.convertToPdf(new ClassPathResource("contract/labor_contract_general.html").getInputStream(),pdfDocument,converterProperties);
            return outputStream;
//            try{
