...
import com.benjamin.smarterp.repository.jpa.ClientRepository;
import com.fasterxml.jackson.databind.ObjectMapper;

public class JpaRegisterClientRepository implements RegisteredClientRepository {
	
	private final ClientRepository clientRepository;
	private final ObjectMapper objectMapper;
	
	
	public JpaRegisterClientRepository(ClientRepository clientRepository, ObjectMapper objectMapper) {
		super();
	...
	private RegisteredClient toObject(Client client) {
		...
		Set<String> authorizationGrantTypes = StringUtils.commaDelimitedListToSet(client.getAuthorizationGrantType());
	...
	private Client toEntity(RegisteredClient registeredClient) {
		...
		entity.setAuthorizationGrantType(StringUtils.collectionToCommaDelimitedString(authorizationGrantTypes));
