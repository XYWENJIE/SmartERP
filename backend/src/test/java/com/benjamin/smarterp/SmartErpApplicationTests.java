...
//		String body = mvcResult.getResponse().getContentAsString(StandardCharsets.UTF_8);
	 ...
	 */
	@Test
	public void printPDF() throws IOException, TemplateException {
		Team team = new Team();
		team.setId(1);
		team.setTeamName("深圳市壹家播商网络科技有限公司");
		Personnel personnel = new Personnel();
		personnel.setRealName("黄文杰");
		personnel.setPhone("13530995506");
		...
		LaborContracts laborContracts = new LaborContracts();
		laborContracts.setPersonnel(personnel);
		laborContracts.setTeam(team);
		OutputStream outputStream = this.personnelService.generationLaborContract(laborContracts);
		log.info("任务执行完成");
